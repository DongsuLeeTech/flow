    ...
    def _apply_rl_actions(self, rl_actions):
        ...
        if rl_actions:
            ...
            for i in rl_actions.values():
                ...
                # print('MDP accel : ', accel[0][0], 'MDP LC', lc[0])
                # print('====')
                # f = open(file_name5, 'a')
                # f.write('{},'.format(accel[0][0]))
                # f.write('{}\n'.format(lc[0]))
                # f.close()
            ...
            if kwargs['fail'] or self.crash:
                ...
                if self.crash==False:
                    ...
                    if leader_uns_p:
                        ...
                        # print(headway, rl_speed, leader_speed)
                        # print('===')
                    ...
                    # print('le:',rwds['leader_uns_penalty'], 'fo:', rwds['uns4IDM_penalty'] )
