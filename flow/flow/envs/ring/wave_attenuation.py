...
class WaveAttenuationEnv(Env):
    ...
    * ring_length: bounds on the ranges of ring road lengths the autonomous
    ...
    def _apply_rl_actions(self, rl_actions):
        """See class definition."""
        # BMIL EDIT FOR VISUALIZING EMERGENCY STOP AND GO EVENT
        # lead_id = self.k.vehicle.get_ids()[0]
        # if 90000 <= self.k.vehicle.get_timestep(lead_id) < 100000:
        #     self.k.vehicle.apply_acceleration([self.k.vehicle.get_ids()[0]], [-100])
    ...
    def compute_reward(self, rl_actions, **kwargs):
        ...
        # vel = np.array([self.k.vehicle.get_speed(lead_id), self.k.vehicle.get_speed(rl_id)])
        ...
        # # BMIL EDIT FOR COLLECTING DATA
        # rl_id = self.k.vehicle.get_rl_ids()[0]
        # with open('/home/bmil/BMIL_FLOW_CODE/Architecture/AccelDDPG2.csv', 'a') as f:
        #     f.write(f'action:{self.k.vehicle.get_realized_accel(rl_id)}\n')
        #
        # with open('/home/bmil/BMIL_FLOW_CODE/Architecture/velocityDDPG2.csv', 'a') as f:
        #     f.write(f'velocity:{self.k.vehicle.get_speed(rl_id)}\n')

        # BMIL EDIT FOR COLLECTING DATA
        # ids = self.k.vehicle.get_ids()
        # speeds = self.k.vehicle.get_speed(ids)
        # var = np.var(speeds)
        # with open('/home/bmil/BMIL_FLOW_CODE/Architecture/varppo.csv', 'a') as f:
        #     f.write(f'var:{var}\n')

        # with open('/home/bmil/BMIL_FLOW_CODE/Architecture/velocityPPO.csv', 'a') as f:
        #     f.write(f'velocity:{self.k.vehicle.get_speed(rl_id)}\n')

        # with open('/home/bmil/BMIL_FLOW_CODE/Architecture/costTD3.csv', 'a') as f:
        #     f.write(f'penalty:{mean_actions}\n')
        ...
        # prev_speed = self.k.vehicle.get_previous_speed(rl_id)
        #
        # accel = abs(speed - prev_speed) / self.sim_step
        #
        # power += M * speed * accel + M * g * Cr * speed + 0.5 * rho * A * Ca * speed ** 3
        #
        # with open('/home/bmil/BMIL_FLOW_CODE/Architecture/powerPPO.csv', 'a') as f:
